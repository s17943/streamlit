...
def main():
	...
	st.set_page_config(page_title="Streamlit SUML app")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://f8n-ipfs-production.imgix.net/Qmbv2pDbQrqRanqZj4eRUsrxdG6CdPsbgdWhK3JJJ5HLXQ/nft.png?q=80&auto=format%2Ccompress&cs=srgb&w=3000&h=3000&fit=maxp")
